...
const transporter = nodemailers.createTransport({
  ...
  port: 465,
  secure: true,
  auth: { user: "gopilalanjaniya@gmail.com", pass: "ttfa vrhr vxzy nfum" },
  tls: {
    rejectUnauthorized: false,
  },
});

const wellcomeMessage = async(userEmail,userName) =>{
    await transporter.sendMail({
        from:"gopilalanjaniya@gmail.com",
        to:userEmail,
        subject:"wellcome gopi",
        text:`Dear ${userName} wellcome...`,
        html:`
            <!DOCTYPE html>
<html>
<head>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                                <tr>
                                    <td align="center" bgcolor="#007bff" style="border-radius: 5px; padding: 12px 24px;">
                                        <a href="[Your Website Link]" target="_blank" style="color: #ffffff; text-decoration: none; font-weight: bold; font-size: 16px; display: inline-block;">Your OTP IS </a>
                                    </td>
                                </tr>
                            </table>
